...
public class AdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
    	...
    	if(method.equals("getUsersGraph")){
    		Map<String,Integer> userCountCategoryWise=UserDAO.getUserCountCategoryWise();
    	  ...
    	  out.close();
    			...
    			Map<String,Integer> productCountCategoryWise=ProductDao.getProductCountCategoryWise();
        		out = response.getWriter();  
